            ...
            <form class="row g-3" method="post" wire:submit.prevent="store">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="Name-o2" class="control-label mb-1">{{ __('Name') }}</label>
                        <input id="Name-o2" value="" wire:model.defer="applicant.name"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label mb-1">{{__("Email")}}</label>
