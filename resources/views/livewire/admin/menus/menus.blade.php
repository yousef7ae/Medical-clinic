<div>
    ...
    <div class="container-fluid py-3">
        ...
        <div class="main h-100">
            <h2 class="text-primary">{{__("Menus")}}</h2>
            <div class="row g-0 mb-3">
                <div class="col-md-3 align-self-end">
                    <div class="d-inline">
                        @if(auth()->user()->can('menus create') )
                            <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#CreateMenu"
                                data-bs-original-title="" title=""><i
                                    class="fa-solid fa-user-plus pe-1"></i> {{__("Create Menu")}} </a>
                        @endif
                    </div>
                </div>
                <div class="col-md-9">
                        ...
                        @foreach($menus as $key => $menu)
                            <tr>
                                <td class="text-center p-1">
                                    <div class="table-os">{{ $key + $menus->firstItem() }}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$menu->title}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">
                                        ...
                                        @if(auth()->user()->can('menus delete') )
                                            <a class="btn btn-sm mx-1 btn-danger" href="#"
                                               ...
                                               data-bs-toggle="modal" data-bs-target="#deleteModalMenu">
...
@if(auth()->user()->can('menus create') )
    <!--  Modal CreateMenu -->
        <div class="modal fade" wire:ignore.self id="CreateMenu" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    ...
                    <div class="text-center text-primary border-bottom">
                        <h5 class="" id="exampleModalLabel">{{__("Create Menu")}}</h5>
                    </div>
                    <div>
                        <div wire:loading>
                        ...
                        @livewire('admin.menus.menus-create',[$menu_id])
                </div>
            </div>
        </div>
        <!--  Modal CreateMenu -->
...
@if(auth()->user()->can('menus edit') )
    <!--  Modal EditMenu -->
        <div class="modal fade" wire:ignore.self id="EditMenu" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    <div class="modal-header border-0 py-0">
                    ...
                    <div class="text-center text-primary border-bottom">
                        <h5 class="" id="exampleModalLabel">{{__("Edit Menu")}}</h5>
                    </div>
                    <div>
                        <div wire:loading>
                            <i class="fas fa-sync fa-spin"></i>
...
@if(auth()->user()->can('menus delete') )
    <!-- Modal deleteModalMenu -->
        <div wire:ignore.self class="modal fade" id="deleteModalMenu" tabindex="-1" role="dialog"
             aria-labelledby="deleteModalMenuLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalMenuLabel">{{__("Delete Confirm")}}</h5>
