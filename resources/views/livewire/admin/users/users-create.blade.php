<div class="container-fluid py-3">
    <div class="py-4">
        ...
        <h2 class="h4 text-center py-3">{{__("Add a new patient")}}</h2>
                    ...
                    <div class="border  row pt-3">
                        <div class="col-6 mb-2">
                            <div class="form-group position-relative">
                                ...
                                <input value="" wire:model="user.name" placeholder="Add Name"
                                       name="name"
...
{{--                                <input class="form-check-input" wire:model="user.medical_history" type="checkbox"--}}
{{--                                       id="inlineCheckbox1" value="1">--}}
{{--                                <label class="form-check-label" for="inlineCheckbox1">DIABETES MELLITUS</label>--}}
{{--                            </div>--}}
{{--                            <div class="form-check form-check-inline">--}}
{{--                                <input class="form-check-input" wire:model="user.medical_history2" type="checkbox"--}}
{{--                                       id="inlineCheckbox2" value="1">--}}
{{--                                <label class="form-check-label" for="inlineCheckbox2">HYPERTENSION</label>--}}
{{--                            </div>--}}
{{--                            <div class="form-check form-check-inline">--}}
{{--                                <input class="form-check-input" wire:model="user.medical_history3" type="checkbox"--}}
...
{{--                            <div class="form-check form-check-inline">--}}
{{--                                <input class="form-check-input" wire:model="user.surgery" type="checkbox"--}}
{{--                                       id="inlineCheckbox1" value="1">--}}
{{--                                <label class="form-check-label" for="inlineCheckbox1">RADICAL PROSTATECTOMY</label>--}}
{{--                            </div>--}}
{{--                            <div class="form-check form-check-inline">--}}
{{--                                <input class="form-check-input" wire:model="user.surgery2" type="checkbox"--}}
{{--                                       id="inlineCheckbox2" value="1">--}}
{{--                                <label class="form-check-label" for="inlineCheckbox2">Abdominal Surgery</label>--}}
{{--                            </div>--}}
{{--                            <div class="form-check form-check-inline">--}}
{{--                                <input class="form-check-input" wire:model="user.surgery3" type="checkbox"--}}
{{--                                       id="inlineCheckbox3" value="1">--}}
