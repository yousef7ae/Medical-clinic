                                ...
                                <td class="text-center p-1">
                                    <div class="table-os">
                                        <img width="50" class="img-fluid rounded"
                                             src="{{ $service->image ? $service->image : url('dashboard/img/image1.png')}}"
                                             data-holder-rendered="true">
                                    </div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$service->title}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{ Str::limit($service->description,50) }}</div>
                                </td>
