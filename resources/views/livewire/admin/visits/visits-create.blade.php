...
{{--        </div>--}}
        ...
        <div class="form-group col-12">
            ...
            <textarea class="form-control @error('visit.diagnosis') is-invalid @enderror "
                      wire:model.defer="visit.diagnosis" placeholder="{{__("Add Diagnosis")}}" id="form11"
                      rows="4"></textarea>
        ...
        <div class="form-group col-12">
            ...
            <textarea class="form-control @error('visit.notes') is-invalid @enderror " wire:model.defer="visit.notes"
                      placeholder="{{__("Add Notes")}}" id="form11" rows="4"></textarea>
            @error('visit.notes')
            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
            @enderror
        </div>
