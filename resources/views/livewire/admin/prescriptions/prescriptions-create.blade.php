    ...
    <div class="row g-2">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select @if(isset($prescription['patient_id'])) disabled
                        @endif wire:model.defer="prescription.patient_id"
        ...
        @if (!auth()->user()->hasRole('Doctor'))
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select @if(isset($prescription['doctor_id']) && $prescription['doctor_id']) disabled
                            @endif wire:model.defer="prescription.doctor_id"
        ...
        <div class="form-group col-12">
            ...
            <textarea class="form-control @error('prescription.notes') is-invalid @enderror "
                      wire:model.defer="prescription.notes" placeholder="{{__("Add Notes")}}" id="form11"
                      rows="4"></textarea>
