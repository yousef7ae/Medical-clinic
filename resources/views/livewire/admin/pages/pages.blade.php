                                ...
                                <td class="text-center p-1">
                                    <div class="table-os">
                                        <img width="50" class="img-fluid rounded"
                                             src="{{ $page->image ? $page->image : url('dashboard/img/image1.png')}}"
...
@if(auth()->user()->can('pages create') )
    <!--  Modal CreatePage -->
        <div class="modal fade" wire:ignore.self id="CreatePage" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    ...
                    <div class="text-center text-primary border-bottom">
                        <h5 class="" id="exampleModalLabel">{{__("Create Page")}}</h5>
                    </div>
                    <div>
                        <div wire:loading>
                    ...
                    @livewire('admin.pages.pages-create',[$page_id])
...
@if(auth()->user()->can('pages edit') )
    <!--  Modal EditPage -->
        <div class="modal fade" wire:ignore.self id="EditPage" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    <div class="modal-header border-0 py-0">
                    ...
                    <div class="text-center text-primary border-bottom">
                        <h5 class="" id="exampleModalLabel">{{__("Edit Page")}}</h5>
                    </div>
                    <div>
                        <div wire:loading>
                            <i class="fas fa-sync fa-spin"></i>
