...
class ConsultationsCreate extends Component
{
    ...
    public function store()
    {
        $this->validate([
            ...
            'consultation.drug_allergies' => 'nullable',
    ...
    {
        return view('livewire.admin.consultations.consultations-create')->layout('layouts.admins.app');
    }
}
