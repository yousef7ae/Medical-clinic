...
class AnalysesPrint extends Component
{
    public $patient_id, $name_patient, $analyses, $id_number, $birth_date, $occupation, $mobile, $birth_place;
    ...
    public function render()
    {
        ...
        $pdf = ArabicLaravelMpdf::loadView('livewire.admin.patient-print.analyses-print', [
        ...
        return view('livewire.admin.patient-print.analyses-print')->layout('layouts.admins.app_print')->with('downloadResponse', $downloadResponse);
    }
