...
class PrescriptionsPrint extends Component
{
    public $patient_id, $name_patient, $prescriptions, $id_number, $birth_date, $occupation, $mobile, $birth_place;
    ...
    public function render()
    {
        ...
        $pdf = ArabicLaravelMpdf::loadView('livewire.admin.patient-print.prescriptions-print', [
        ...
        return view('livewire.admin.patient-print.prescriptions-print')->layout('layouts.admins.app_print')->with('downloadResponse', $downloadResponse);
    }
