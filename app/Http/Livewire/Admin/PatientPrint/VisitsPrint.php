...
class VisitsPrint extends Component
{
    public $patient_id, $name_patient, $visits, $id_number, $birth_date, $occupation, $mobile, $birth_place;
    ...
    public function render()
    {
        ...
        $pdf = ArabicLaravelMpdf::loadView('livewire.admin.patient-print.visits-print', [
        ...
        if ($this->patient_id) {
            $visits = $visits->where('patient_id', $this->patient_id);
        }

        $visits = $visits->orderBy('created_at', 'DESC')->get();

        return view('livewire.admin.patient-print.visits-print')->layout('layouts.admins.app_print')->with('downloadResponse', $downloadResponse);
    }
}
